...
import (
	"gitlab.wildberries.ru/wbwh/support/backend/wh-support.git/api_adapters/supplier_api_adapter/internal/service"
...
func main() {
	...
	runner.RegisterCustomHandler("GetSupplierInfoByNmIDs", srv.GetSupplierInfoByNmIDs)

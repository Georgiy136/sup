...
func (t *TicketNotificationsService) handleRejectedOperation(ctx context.Context, notification ticketmodels.TicketNotification, requiredSiteAction bool) error {
	...
	statusText := templates.GetTicketStatusTextByOperationType(consts.RejectOperation, notification.TicketInfo.RejectedEmployeeID)
